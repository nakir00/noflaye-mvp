...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_MAIL_TO', 'admin@noflaye.com'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@noflaye.com'),
                'name' => env('MAIL_FROM_NAME', 'Noflaye Backup'),
            ],
        ],
